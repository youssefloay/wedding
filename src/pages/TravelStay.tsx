    ...
    <div className="py-[140px] px-5 text-center">
      <div className="mx-auto max-w-sm flex flex-col items-center">
        ...
        <div className="w-full text-left mb-8">
          ...
          <div className="w-full bg-[#f4ebd9] border-[1.5px] border-[#d4c8bc] rounded-[6px] px-6 py-6 shadow-[0_8px_16px_rgba(110,95,80,0.15)] space-y-4 font-serif text-[#3b3228]">
            
            <div className="leading-snug">
              <span className="text-[17px] font-medium block mb-1">Stay at Castillo de Monda</span>
              <span className="text-[15px] text-[#5c4a3d] block">&bull; Details in your RSVP</span>
            </div>
            ...
            <div className="leading-snug">
              ...
              <span className="text-[15px] text-[#5c4a3d] font-normal">&bull; 20-25 min drive (recommended)</span>
            </div>
            ...
            <div className="leading-snug">
              ...
              <span className="text-[15px] text-[#5c4a3d] font-normal">&bull; 5 min walk (closer)</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full text-left">
          ...
          <div className="w-full bg-[#f4ebd9] border-[1.5px] border-[#d4c8bc] rounded-[6px] px-6 py-6 shadow-[0_8px_16px_rgba(110,95,80,0.15)] space-y-5 font-serif text-[#3b3228]">
            
            <div className="flex items-center gap-4">
              <span className="opacity-80 text-2xl">✈️</span>
              <span className="text-[16px] text-[#5c4a3d]">Fly to Málaga Airport (AGP)</span>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-[16px] text-[#5c4a3d]">Taxi or transfer (40min)</span>
            </div>
